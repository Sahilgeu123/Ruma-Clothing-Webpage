        ...
        <section className="hero-fullscreen relative w-full h-screen min-h-screen bg-transparent flex items-center justify-center overflow-hidden ">
            ...
            <div className=" z-20 flex flex-col px-6">
                ...
                <div className="mt-8 absolute left-10 bottom-5 flex gap-4">
                    ...
                    <button className="px-6 py-4 border border-gray-800 text-gray-800 rounded-md hover:bg-zinc-300 font-semibold">Explore New In</button>
                </div>
                <div className=" bg-black right-10 bottom-5 hidden fixed sm:flex gap-4  rounded-md shadow-md">
                    <button className="px-10 py-4 border-r-2 text-white">WISHLIST</button>
                    <button className="px-10 py-4 border-l-2 text-white ">CART ( 0 )</button>
                </div>
